...
$experience = [
    [
        ...
        'dateBegin' => 'Jan 2015',
        'dateEnd' => 'Current',
        'text' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur 
    ...
    [
        ...
        'dateBegin' => 'Mar 2012',
        'dateEnd' => 'Dec 2014',
        'text' => 'Consectetur adipisicing elit. Praesentium magnam consectetur 
        vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora 
        soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $experience[$i]['job'];?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['dateBegin'];?> - <span
